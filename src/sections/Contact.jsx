      ...
      <div className="container">
        ...
        >
          <motion.div variants={itemVariants} className="contact-info">
            <h3 style={{ marginBottom: 'var(--spacing-3)' }}>Contact Information</h3>
            
            <div className="info-items" style={{ marginBottom: 'var(--spacing-4)' }}>
              {contactInfo.map((info, index) => (
                ...
                >
                  ...
                  <div>
                    ...
                    <p style={{ margin: '5px 0 0', color: 'var(--text-secondary)' }}>{info.value}</p>
                  </div>
                </motion.a>
              ))}
            </div>
            
            <div className="social-links" style={{ marginBottom: 'var(--spacing-4)' }}>
              <h4 style={{ marginBottom: 'var(--spacing-2)' }}>Connect With Me</h4>
              <div style={{
                display: 'flex',
                gap: 'var(--spacing-2)'
              }}>
...
"
          ...
          <motion.div variants={itemVariants} className="contact-form-container">
            <div className="contact-form glass" style={{
              padding: 'var(--spacing-4)',
              borderRadius: '12px'
            }}>
              <h3 style={{ marginBottom: 'var(--spacing-3)' }}>Send Me a Message</h3>
              ...
              {submitted ? (
                ...
                >
                  <h4 style={{ color: 'var(--success-500)', marginBottom: 'var(--spacing-1)' }}>
            ...
            >
              ...
              <p style={{ marginBottom: 'var(--spacing-3)', color: 'var(--text-secondary)' }}>
      ...
      <footer style={{
        ...
        <div className="container">
          <p style={{ margin: 0, color: 'var(--text-secondary)' }}>
            © {new Date().getFullYear()} Prithviraj Tagadina. All rights reserved.
          </p>
        </div>
      </footer>
    </section>
