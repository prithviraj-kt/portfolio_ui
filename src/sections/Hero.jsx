...
const Hero = () => {
  ...
  const socialVariants = {
    ...
    visible: (i) => ({
      scale: 1,
      transition: { type: "spring", stiffness: 200, damping: 10, delay: 0.8 + i * 0.1 },
    }),
  };
  ...
  return (
    ...
    >
      <div className="container" style={{ width: "100%", padding: "0 1rem" }}>
        ...
        >
          ...
          >
            <motion.h3
              ...
              style={{fontSize: "clamp(2.5rem, 5vw, 4rem)", color: "var(--primary-400)", marginBottom: "0.5rem" }}
            >
              I am,
            </motion.h3>
            <motion.h1
            ...
            <motion.div
              variants={itemVariants}
              style={{ fontSize: "clamp(1.5rem, 3vw, 2rem)", marginBottom: "1rem", height: "2.5rem" }}
            >
        ...
        <motion.div
              variants={itemVariants}
              style={{ margin:"20px", display: "flex", gap: "1rem", flexWrap: "wrap", justifyContent: "center" }}
            >
            ...
            <motion.div style={{ display: "flex", gap: "1rem", marginTop: "1rem", justifyContent: "center" }}>
