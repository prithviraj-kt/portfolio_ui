...
const Projects = () => {
  ...
  //     description: 'Built a fitness coaching web app using ReactJS and Firebase. Users receive personalized body analytics (fat/calories) and workout recommendations. Integrated image-to-calorie analysis and daily calorie burn tracking, leveraging AI for over 90% accuracy in predictions.',
  //     techStack: ['ReactJS', 'Firebase', 'AI/ML'],
  //     liveLink: 'https://your-lets-workout-demo.com',
  //     githubLink: 'https://github.com/yourusername/lets-workout',
  //     featured: true
  //   },
  //   {
  //     id: 2,
  ...
  //     description: 'Designed and implemented a blockchain-based NFT authentication system, enabling 90% validation of NFTs before marketplace listing. Developed a secure NFT marketplace workflow that ensures 100% of displayed NFTs are verified, increasing user trust and engagement.',
  //     techStack: ['Blockchain', 'Solidity', 'Ethereum', 'Smart Contracts'],
  //     liveLink: 'https://your-nft-project-demo.com',
  //     githubLink: 'https://github.com/yourusername/nft-authentication'
  //   },
  //   {
  //     id: 3,
  ...
  //     description: 'Built a full-featured e-commerce platform using React, Node.js, Express, and MongoDB, supporting product search, filtering, cart management, and secure payment processing via Stripe. Implemented user authentication, resulting in improved data security and streamlined checkout experience.',
  ...
  //     description: 'Developed a personal finance tracker web app using ReactJS, Bootstrap, and Firebase. Users can log in, track daily expenses, set daily and monthly spending limits, receive reminders, and view spending by date. Enabled real-time updates and responsive UI for seamless expense management.',
  //     techStack: ['ReactJS', 'Bootstrap', 'Firebase'],
  //     liveLink: 'https://your-dollar-account-demo.com',
  //     githubLink: 'https://github.com/yourusername/dollar-account'
  //   },
  //   {
  //     id: 5,
  //     title: 'Digi Elective',
  ...
  //     description: 'Built a comprehensive elective selection system using the MERN stack, featuring dedicated portals for students, HODs, and the Principal. Streamlined the elective management process, improving course selection efficiency by 90% for over 500 students. Engineered a multi-portal management system, reducing elective approval processing time by 30% across multiple departments.',
  //     techStack: ['MongoDB', 'Express', 'React', 'Node.js'],
  //     liveLink: 'https://your-digi-elective-demo.com',
  //     githubLink: 'https://github.com/yourusername/digi-elective'
  //   },
  //   {
  //     id: 6,
  ...
  //     description: 'Developed a website builder platform using ReactJS and Gemini 2.5 Pro. Integrated web containers to display both code and output in-browser, running code locally to minimize latency. Enabled users to create, preview, and deploy web projects efficiently with AI-powered assistance.',
  //     techStack: ['ReactJS', 'Gemini 2.5 Pro', 'Web Containers'],
  //     liveLink: 'https://your-auto-site-builder-demo.com',
  //     githubLink: 'https://github.com/yourusername/auto-site-builder'
  //   }
  // ];
