  ...
  const educationData = [
    {
      ...
      date: '2024-2026',
      description: 'Specialised in Generative AI, LLM and explored the world of Machine Learning, Deep learning.',
      grade: 'CPI: 7.0/10.0',
    ...
    },
    {
      ...
      date: '2019 - 2023',
      description: 'Focused on building fundamentals of computer science, building production grade softwares.',
      grade: 'CPi: (9.0/10.0)',
      icon: <FaSchool />,
    ...
    },
    {
      ...
      degree: 'PCMB',
      date: '2017 - 2019',
      description: 'Explored the fields of Physics, Maths, Chemistry and Biology',
          ...
          {educationData.map((item, index) => (
            ...
            >
              ...
              >
                ...
                {item.grade && (
                  <div className="education-grade" style={{ marginTop: '1rem' }}>
 ...
 */}
                ...
                <div className="education-skills" style={{
                  display: 'flex',
                  flexWrap: 'wrap',
                  gap: '0.5rem',
                  marginTop: '1rem'
                }}>
                  {['JavaScript', 'Python', 'UX Design', 'Algorithm Design'].map((skill, i) => (
                    <motion.span
                      key={i}
